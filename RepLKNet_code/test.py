...
import os
from image_processing import Preproc, Rescale, RandomCrop, ToTensor, Resize
...
if __name__ == '__main__':
    ...
    # 从dataloader中取一个batch作为测试输入
    inputs, classes = next(iter(dataloaders))


    def test(model, criterion):
        best_model_wts = torch.load('/home/duwb/xiaobing/medical-image-processing/best_model_RepLK.pth')
